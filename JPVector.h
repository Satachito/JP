...
namespace JP {
	...
	Vector 	: vVector< F > {
		...
		const Vector< F >&	operator +=	( const vVector< F >& p		) { _Add( vVector< F >::m, vVector< F >::s, p.m, p.s, vVector< F >::m, vVector< F >::s, vVector< F >::n );	return *this; }
		const Vector< F >&	operator -=	( const vVector< F >& p		) { _Sub( vVector< F >::m, vVector< F >::s, p.m, p.s, vVector< F >::m, vVector< F >::s, vVector< F >::n );	return *this; }
		const Vector< F >&	operator *=	( const vVector< F >& p		) { _Mul( vVector< F >::m, vVector< F >::s, p.m, p.s, vVector< F >::m, vVector< F >::s, vVector< F >::n );	return *this; }
		const Vector< F >&	operator /=	( const vVector< F >& p		) { _Div( vVector< F >::m, vVector< F >::s, p.m, p.s, vVector< F >::m, vVector< F >::s, vVector< F >::n );	return *this; }
		const Vector< F >&	operator +=	( F p						) { _Add( vVector< F >::m, vVector< F >::s,  p, vVector< F >::m, vVector< F >::s, vVector< F >::n );		return *this; }
		const Vector< F >&	operator -=	( F p						) { _Add( vVector< F >::m, vVector< F >::s, -p, vVector< F >::m, vVector< F >::s, vVector< F >::n );		return *this; }
		const Vector< F >&	operator *=	( F p						) { _Mul( vVector< F >::m, vVector< F >::s,  p, vVector< F >::m, vVector< F >::s, vVector< F >::n );		return *this; }
		const Vector< F >&	operator /=	( F p						) { _Div( vVector< F >::m, vVector< F >::s,  p, vVector< F >::m, vVector< F >::s, vVector< F >::n );		return *this; }
	};
	...
	template	< typename F >	Vector< F >			operator -		( F s						, const vVector< F >& p		) { Vector< F > v( s, p.n );			_Sub	( v.m, v.s, p.m, p.s, v.m, v.s, v.n );				return v; }
	...
	template	< typename F >	Vector< F >			Rec				( const vVector< F >& p			) {	assert( p.s == 1 );	Vector< F > v( p );	assert( v.s == 1 );	_Rec	( p.m, v.m, (int)v.n );								return v; }
	template	< typename F >	Vector< F >			Exp				( const vVector< F >& p			) {	assert( p.s == 1 );	Vector< F > v( p );	assert( v.s == 1 );	_Exp	( p.m, v.m, (int)v.n );								return v; }
